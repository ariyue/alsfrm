...
//-------------------------------
    ...
    function getProductMenu(productMenuCode){

    	var param = {
    			//pid: "IOA"
    			pid: productMenuCode || "IOA",
    			userId:  "VIVI@00001"//"sdevadmin@00000" //TODO 测试时使用
		};
    	var cmd = new $$.Command();
		var url = ROOT_PATH + "umsmenu/getloginusermenu";
		//alert("url=" + url);
		cmd.setUrl(url);
		cmd.setParam(param);
		//alert(33333);
